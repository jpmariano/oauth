...
class feedback{
  public static function miniorange_oauth_server_feedback()
  {
    global $base_url;
        ...
        <div class="modal-dialog" style="width: 500px;">
          <div class="modal-content" style="border-radius: 20px">
            <div class="modal-header"
              ...
              <h4 class="modal-title" style="color: white; text-align: center;"> Hey, it seems like you want to deactivate miniOrange OAuth Server Module</h4>
              <hr>
            ...
            <div class="modal-body"
              ...
              <form name="f" action="<?php echo $feedback_url;  ?>" id="mo_feedback">
                <div>
                  <p>
                    <?php
                    if(empty(\Drupal::config('oauth_server_sso.settings')->get('oauth_server_sso_customer_admin_email')))
                    { ?>
